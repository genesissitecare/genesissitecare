 ...
 * Genesis Site Care.		
 *		
 * This file adds gulp tasks to the Genesis Site Care theme.		
 *		
 * @author SEO themes		
 */
...
gulp.task('translate', function () {
	...
	return gulp.src(paths.php)
		...
		.pipe(wpPot({
			domain: 'genesissitecare',
			destFile: 'genesissitecare.pot',
			package: 'Genesis Site Care',
...
gulp.task('rename', function () {
	...
	var old_proxy = 'genesissitecare.dev',
		old_name = 'Genesis Site Care',
		old_domain = 'genesissitecare',
		old_prefix = 'gsc_',
		old_package = 'GenesissitecarePro';
...
gulp.task('watch', function () {
	...
	// HTTPS (optional).
	browsersync({
		proxy: 'https://genesissitecare.dev',
		port: 8000,
		notify: false,
		open: false,
		https: {
			"key": "/Users/seothemes/.valet/Certificates/genesissitecare.dev.key",
			"cert": "/Users/seothemes/.valet/Certificates/genesissitecare.dev.crt"
		}
	});
